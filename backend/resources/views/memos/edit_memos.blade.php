<div class="card article-body">
    ...
    <div class="card-text article-body__news-link">
        <a class="font-sm article-body__news-link-text" href="{{$article->url}}" target=”_blank” rel="noopener noreferrer">関連記事:{{$article->newsLink->news}}</a>
    </div>
    ...
    <div class="card-text memo-body">
        @include('error_list')
        <div class="card-text my-2 font-sm"><i class="fas fa-lock fa-fw"></i>編集するメモ</div>
        @if( Auth::id() === $article->user_id )
