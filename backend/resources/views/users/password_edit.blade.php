...
<div class="container">
    <div class="card password-reset-body">
        <div class="card-body password-reset-body__content">
            ...
            <div class="card-body">
                <form method="post" action="{{route('users.update_password',['name' => Auth::user()->name])}}">
                    ...
                    <div class="form-group font-sm">
                        ...
                        <div>
                            <input id="current" type="password" class="form-control password-reset-body__form" name="current_password" required autofocus>
                        </div>
                    </div>
                    <div class="form-group font-sm">
                        <label for="password">新しいのパスワード</label>
                        <div>
                            <input id="password" type="password" class="form-control password-reset-body__form" name="new_password" required>
                        </div>
                    </div>
                    <div class="form-group font-sm">
                        <label for="confirm">新しいのパスワード（確認用）</label>
                        <div>
                            <input id="confirm" type="password" class="form-control password-reset-body__form" name="new_password_confirmation" required>
                        </div>
                    </div>
                    <div>
