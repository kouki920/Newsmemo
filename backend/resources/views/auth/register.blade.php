            ...
            <div class="card-text">
                <form action="{{route('register')}}" method="POST" novalidate="novalidate">
                    ...
                    <div class="register-body__name">
                        <label for="name" class="font-sm register-body__name-text">-お名前-</label>
                    ...
                    <div class="register-body__email">
                        <label for="email" class="font-sm register-body__email-text">-メールアドレス-</label>
                    ...
                    <div class="register-body__password">
                        <label for="password" class="font-sm register-body__password-text">-パスワード-</label>
                    ...
                    <div class="register-body__password-confirmation">
                        <label for="password__confirmation" class="font-sm register-body__password-confirmation-text">-パスワード(再確認)-</label>
