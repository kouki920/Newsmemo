...
<div class="form-group card-footer">
    ...
    <a href="{{$article->newsLink->url}}" class="font-sm article-edit-body__news-link" target=”_blank” rel="noopener noreferrer">関連記事:{{$article->newsLink->news}}</a>
</div>
<button type="submit" class="btn article-edit-body__update-button font-sm">更新</button>