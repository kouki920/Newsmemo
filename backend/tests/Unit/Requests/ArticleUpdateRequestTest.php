...
class ArticleUpdateRequestTest extends TestCase
{
    ...
    /**
     * 投稿内容の更新機能のバリデーションテスト
     *
     * @param array 項目名の配列
     * @param array 値の配列
     * @param boolean 期待値(true:バリデーションOK、false:バリデーションNG)
     * @dataProvider dataArticleUpdate
     */
    public function testArticleUpdate(array $keys, array $values, bool $expect)
    {
    ...
    public function dataArticleUpdate()
    {
        return [
            'OK' => [
                ['body', 'tags', 'news', 'url'],
